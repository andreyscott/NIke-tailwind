...
const Header = () => {
  return (
    <div className=" bg-[#f5f5f5] px-12  h-8 items-center text-sm   justify-between flex">
     <div className="flex w-20  justify-between">
      <Link to="/jordan">
        <div className=" py-1 hover:opacity-50 hover:cursor-pointer svg-top">
      ...
      <Link to="/jordan">
        <div className=" py-1 hover:opacity-50 hover:cursor-pointer">
      ...
      <div className="">
        <nav>
          <ul className="flex">
            ...
            <li className="opacity-80 my-0 mx-3 hover:opacity-50 hover:cursor-pointer m-1">|</li>
